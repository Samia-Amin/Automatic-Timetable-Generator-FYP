<?php
	...
	if(isset($_POST['submit'])){
		...
		$query = "INSERT INTO subject(sub_name,fac_sub_id,sem_id,lab_required) VALUES('$sub_name','$fac_sub_id','$sem_id','$lab_required')";
		...
		<div class="container pt-5" >
			<div class="fpanel" >
				<fieldset style="padding:10px 20px;margin-bottom:20px;">
						<legend style="width:auto;font-weight:bold;color:#020031;">Add subject Details</legend>
