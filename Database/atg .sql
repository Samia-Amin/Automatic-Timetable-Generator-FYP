...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2020 at 07:11 AM
...
(175, 'Capstone Project II', 2, 10, 32, 'no'),
(176, 'Capstone Project II', 2, 11, 33, 'no'),
(177, 'Cloud Computing', 2, 34, 31, 'no'),
(178, 'Cloud Computing', 2, 34, 32, 'no'),
(179, 'Cloud Computing', 2, 34, 33, 'no'),
(180, 'Professional Practices', 2, 20, 31, 'no'),
(181, 'Professional Practices', 2, 20, 32, 'no'),
(182, 'Professional Practices', 2, 57, 33, 'no'),
(183, 'Mobile Application Development', 2, 60, 31, 'no'),
(184, 'Mobile Application Development', 2, 60, 32, 'no'),
(185, 'Mobile Application Development', 2, 60, 33, 'no'),
(186, 'Principles of Soft Computing', 2, 15, 34, 'no'),
(187, 'Principles of Soft Computing', 2, 15, 35, 'no'),
(188, 'Principles of Soft Computing', 2, 15, 36, 'no'),
(189, 'Principles of Soft Computing', 2, 15, 37, 'no'),
(190, 'Principles of Soft Computing', 2, 15, 47, 'no'),
(191, 'Artificial Intelligence', 2, 47, 34, 'no'),
(192, 'Artificial Intelligence', 2, 47, 35, 'no'),
(193, 'Artificial Intelligence', 2, 27, 36, 'no'),
(194, 'Artificial Intelligence', 2, 27, 37, 'no'),
(195, 'Artificial Intelligence', 2, 22, 47, 'no'),
(196, 'Human Computer Interaction', 2, 29, 34, 'no'),
(197, 'Human Computer Interaction', 2, 14, 35, 'no'),
(198, 'Human Computer Interaction', 2, 14, 36, 'no'),
(199, 'Human Computer Interaction', 2, 14, 37, 'no'),
(200, 'Human Computer Interaction', 2, 69, 47, 'no'),
(201, 'Human Computer Interaction', 2, 69, 47, 'no'),
(202, 'Principles of Management', 2, 48, 34, 'no'),
(203, 'Principles of Management', 2, 48, 35, 'no'),
(204, 'Principles of Management', 2, 61, 36, 'no'),
(205, 'Principles of Management', 2, 96, 37, 'no'),
(206, 'Principles of Management', 2, 112, 47, 'no'),
(207, 'Web Systems and Technologies', 2, 35, 34, 'no'),
(208, 'Web Systems and Technologies', 2, 35, 35, 'no'),
(209, 'Web Systems and Technologies', 2, 28, 36, 'no'),
(210, 'Web Systems and Technologies', 2, 28, 37, 'no'),
(211, 'Web Systems and Technologies', 2, 28, 47, 'no'),
(212, 'Multimedia Systems and Design', 2, 30, 34, 'no'),
(213, 'Multimedia Systems and Design', 2, 68, 35, 'no'),
(214, 'Multimedia Systems and Design', 2, 68, 36, 'no'),
(215, 'Multimedia Systems and Design', 2, 63, 37, 'no'),
(216, 'Multimedia Systems and Design', 2, 63, 47, 'no'),
(217, 'Capstone Project II', 2, 11, 42, 'no'),
(218, 'Professional Practice', 2, 84, 42, 'no'),
(219, 'Cloud Computing', 2, 107, 42, 'no'),
(220, 'Design Patterns', 2, 90, 42, 'no'),
(221, 'Entrepreneurship', 2, 86, 42, 'no'),
(222, 'Software Project Management', 2, 29, 43, 'no'),
(223, 'Software Project Management', 2, 29, 44, 'no'),
(224, 'Software Project Management', 2, 95, 45, 'no'),
(225, 'Formal Methods in Software Engineering', 2, 33, 43, 'no'),
(226, 'Formal Methods in Software Engineering', 2, 33, 44, 'no'),
(227, 'Formal Methods in Software Engineering', 2, 33, 45, 'no'),
(228, 'Software CASE Tools & Applications', 2, 25, 43, 'no'),
(229, 'Software CASE Tools & Applications', 2, 25, 44, 'no'),
(230, 'Software CASE Tools & Applications', 2, 65, 45, 'no'),
(231, 'Enterprise Application Development', 2, 31, 43, 'no'),
(232, 'Enterprise Application Development', 2, 31, 44, 'no'),
(233, 'Enterprise Application Development', 2, 31, 45, 'no'),
(234, 'Artificial Intelligence', 2, 22, 43, 'no'),
(235, 'Artificial Intelligence', 2, 12, 44, 'no'),
(236, 'Artificial Intelligence', 2, 12, 45, 'no'),
(237, 'Advance Algorithm Analysis', 2, 15, 29, 'no'),
(238, 'Informationn Privacy and Security', 2, 23, 29, 'no'),
(239, 'Computer Vision', 2, 89, 29, 'no'),
(240, 'Advance Operating System', 2, 17, 29, 'no'),
(241, 'Advance Computer Architecture', 2, 22, 29, 'no');
...
--
ALTER TABLE `faculty`
  MODIFY `fac_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `semester`
  MODIFY `sem_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `subject`
--
ALTER TABLE `subject`
  MODIFY `sub_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=242;
